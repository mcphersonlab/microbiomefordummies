...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // These keys are preserved from the original synthetic contrast dataset so the page can
  // reuse the existing effect/q-value tables while presenting the new Pre-/+4 terminology.
