...
The interactive demo below lets you **change taxonomic level** and watch both the stacked bars and the significance layer update together.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderLevel(levelName) {
    ...
    const sigChartHeight = 48 + level.taxa.length * 28;
    const zeroX = 150;
