...
::: {.taxa-note}
Use the tree to click through the major intestinal lineages. Colors stay anchored to each top-level phylum throughout the tree so bacterial, archaeal, fungal, and viral branches remain visually distinct. Sub-taxa use progressively lighter shades so you can keep track of which lower-level groups belong to the same higher-level branch.
:::
  ...
  const intestinalTree = {
    ...
    children: [
      ...
      },
      {
        ...
        taxId: 4811,
        phylum: "zygomycota",
        description: "Historically defined fungal phylum still encountered in reference taxonomies and some microbiome annotations."
      },
      {
        name: "Mucoromycota",
        rank: "phylum",
